var _0xd590 = ["ok", "keydown", "addEventListener", "keyCode", "<table><tbody>", "html", "#langMessage", "<tr><td>", " &nbsp;&nbsp;&nbsp;</td><td>", "</td></tr>", "</tbody></table>", "#hiddenLanguageBits", "length", "#scrambler", "setInterval", "cube", "0111111111222222222333333333444444444555555555666666666", "<br />", "<a href=\"/", "\">", "</a>", "href", "attr", "cube=", "each", ".selectlanguage a", "", "split", "generateTables", "postMessage", "%", "width", "#loadingBar", "random", "floor", "removeClass", "#currentRot", "playBack", "#playButton", "round", "orient", "U", "U'", "L", "L'", "F", "F'", "R", "R'", "B",
...
function doInputScramble(e) {
    ...
    for (var t = 0; t < turn[_0xd590[12]]; t++)
        if (type[t] = 0, -1 != turn[t][_0xd590[88]](_0xd590[249]) && (type[t] = 1), -1 != turn[t][_0xd590[88]](_0xd590[250]) && (type[t] = 1),
            turn[t] == turn[t][_0xd590[251]]() && (type[t] = 1), -1 != turn[t][_0xd590[88]](_0xd590[252]) && (type[t] = 2),
            (turn[t] = turn[t][_0xd590[253]](), -1 != turn[t][_0xd590[88]](_0xd590[41])))
            turn[t] = 1;
...
function cleanCube(e) {
    ...
    document[_0xd590[61]](_0xd590[15])[_0xd590[408]] = _0xd590[447], !0 !== e && pushState()
}
