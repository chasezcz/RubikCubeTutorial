...
function() {
    ...
    function M() {
        for (var t = v(336, Int16Array, 336), r = 0; 336 > r; r++)
            for (var o = 0; 336 > o; o++) t[r][o] = l.getURtoDF(r, o);
        return t
    }
        ...
        for (var n = 1; n != q * G * z;) {
            for (var i = 0; q * G * z > i; i++) {
                var a = i % 2,
                    s = (i / 2 | 0) / q | 0,
                    R = (i / 2 | 0) % q;
                if (u.getPruning(o, i) == e)
                    for (var h = 0; 18 > h; h++) switch (h) {
                        case 3:
                        case 5:
                        case 6:
                        case 8:
    ...
    h.prototype.toString = function() {
        ...
        h.prototype.toCubieCube = function() {
            ...
            for (var o in T) {
                ...
                for (var n in T)
                    if (n = T[n], i == O[n.ordinal()][1] && e == O[n.ordinal()][2]) {
                        r.cp[o.ordinal()] = n,
                            r.co[o.ordinal()] = t % 3;
                        break
                    }
        ...
        l.prototype.cornerParity = function() {
            for (var t = 0,
                    r = DRB.ordinal(); r >= URF.ordinal() + 1; r--)
                for (var o = r - 1; o >= URF.ordinal(); o--) this.cp[o].ordinal() > this.cp[r].ordinal() && t++;
            return t % 2
        },
        l.prototype.edgeParity = function() {
            for (var t = 0,
                    r = BR.ordinal(); r >= UR.ordinal() + 1; r--)
                for (var o = r - 1; o >= UR.ordinal(); o--) this.ep[o].ordinal() > this.ep[r].ordinal() && t++;
            return t % 2
        },
        ...
        l.prototype.setFRtoBR = function(t) {
            ...
            for (var s, R = 1; 4 > R; R++)
                for (s = e % (R + 1), e /= R + 1, e = 0 | e; s-- > 0;) this.rotateRight(o, 0, R);
            r = 3;
        ...
        l.prototype.setURtoUL = function(t) {
            ...
            for (var a, s = 1; 3 > s; s++)
                for (a = i % (s + 1), i /= s + 1, i = 0 | i; a-- > 0;) this.rotateRight(o, 0, s);
            r = 2;
        ...
        l.prototype.setURFtoDLB = function(t) {
            for (var r, o = [URF, UFL, ULB, UBR, DFR, DLF, DBL, DRB], i = 1; 8 > i; i++)
                for (r = t % (i + 1), t /= i + 1, t = 0 | t; r-- > 0;) this.rotateRight(o, 0, i);
            for (var e = 7,
        ...
        l.prototype.setURtoBR = function(t) {
            for (var r, o = [UR, UF, UL, UB, DR, DF, DL, DB, FR, FL, BL, BR], i = 1; 12 > i; i++)
                for (r = t % (i + 1), t /= i + 1, t = 0 | t; r-- > 0;) this.rotateRight(o, 0, i);
            for (var e = 11,
